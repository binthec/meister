...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{ url('/') }}" class="logo">
            ...
            <span class="logo-lg"><b>Meister</b></span>
        </a>
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                @if(Auth::user()->role === 1)
                    ...
                    <li class="treeview {{ isActiveUrl('info*') }}">
                        <a href="#">
                            <i class="fa fa-info-circle"></i> <span>お知らせ管理</span>
                            <span class="pull-right-container">
									<i class="fa fa-angle-left pull-right"></i>
								</span>
                        </a>
                        <ul class="treeview-menu">
                            <li class="{{ isActiveUrl('info') }}"><a href="/info"><i class="fa fa-circle-o"></i> お知らせ一覧・検索</a></li>
                            <li class="{{ isActiveUrl('info/create') }}"><a href="{{ url('/info/create') }}"><i class="fa fa-circle-o"></i> お知らせ新規登録</a></li>
                        </ul>
                    </li>
                @endif
